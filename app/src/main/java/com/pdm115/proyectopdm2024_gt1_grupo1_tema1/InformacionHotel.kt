...
class InformacionHotel : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_informacion_hotel, container, false)

        // Encontrar el RecyclerView utilizando la vista inflada
        val recyclerView = view.findViewById<RecyclerView>(R.id.recycler_view_info_hoteles_habitaciones)
    ...
    companion object {
         ...
         * @return A new instance of fragment InformacionHotel.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            InformacionHotel().apply {
